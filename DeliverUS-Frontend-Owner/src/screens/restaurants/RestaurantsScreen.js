  ...
  const renderRestaurant = ({ item }) => {
    return (
      ...
      >
        ...
        <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginRight: '11.7vw' }}>
        <TextSemiBold>Shipping: <TextSemiBold textStyle={{ color: GlobalStyles.brandPrimary }}>{item.shippingCosts.toFixed(2)}€</TextSemiBold></TextSemiBold>
        {item.promoted && <TextSemiBold textStyle={{ color: GlobalStyles.brandPrimary }}>¡En promoción!</TextSemiBold>}
        </View>
